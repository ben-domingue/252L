...
for (Nsample in c(10,100,1000)) {
    ...
    plot(density(sqrt(est[,2])),xlim=c(0,10),xlab="density of SD",main=Nsample) #if you look closely, i am focusing on the variance of the normal in get.est instead of the sd. one always need be mindful of the specific parametrization they are working with (or the software is implicitly using for that matter
}
