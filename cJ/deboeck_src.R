...
m1 = lmer(r2 ~ 0 + item + (1|id), data=VerbAgg, family="binomial")

## Item covariate models

## The regular LLTM
m2 = lmer(r2 ~ 0 + btype + mode + situ + (1|id), data=VerbAgg, family="binomial")
...
m17 = lmer(r2 ~ 0 + item + Anger + Gender + (1|id), data=VerbAgg, family="binomial")
