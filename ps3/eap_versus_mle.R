...
for (i in 1:length(th)) {
    ...
    est1[i]<-optim(0,f1,method='Brent',lower=-10,upper=10,a=a,b=b,c=c,resp=resp)$par
    ##EAP estimation!!
...
df<-data.frame(th=th,est1=est1,est2=est2)
plot(df)
rmse(th,est1)
rmse(th,est2) ##what do you notice about the RMSEs?
